...
A free and lightweight plugin to integrate **Google Analytics 4 (GA4)** into your Joomla website. Supports all major versions: Joomla 3.x, 4.x, 5.x, and 6.x.

## 🚀 Key Features

*   **GA4 Ready:** Fully compatible with the latest Google Analytics 4 properties.
*   **Wide Compatibility:** Works seamlessly with Joomla 3, 4, 5, and 6.
*   **Easy Setup:** Simply paste the full Google Analytics counter code into the plugin settings.
...
| :--- | :--- | :--- |
| **Joomla 3.x** | `plg_google_analytics_j3_v1.2.2.zip` | ✅ Supported |
| **Joomla 4.x** | `plg_google_analytics_j4_v1.2.2.zip` | ✅ Stable |
| **Joomla 5.x** | `plg_google_analytics_j5_v1.2.2.zip` | ✅ Stable |
| **Joomla 6.x** | `plg_google_analytics_j6_v1.2.2.zip` | ✅ Stable |
...
4.  Go to **Plugins**, search for **"System - IWS.BY Google Analytics"** and **Enable** it.
5.  Open the plugin settings and paste the **full Google Analytics Counter Code** (the script provided by GA4).

## 🔑 How to Get Automatic Updates (Free)

This plugin is **100% free**. However, to enable the **automatic update system**, you need a free license key.
...
### 👉 [Get Your Free License Key Here](https://iws.by/en/product/google-analytics-for-joomla/)
...
1.  Clone this repository:
    ```bash
    git clone https://github.com/IWSBY/joomla-iwsby-google-analytics.git
    ```
...
*   **Official Website & Support:** [iws.by](https://iws.by/en/product/google-analytics-for-joomla/)
*   **Google Analytics Official Site:** [analytics.google.com](https://analytics.google.com/)
